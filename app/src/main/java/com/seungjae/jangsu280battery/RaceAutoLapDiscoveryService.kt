...
class RaceAutoLapDiscoveryService : Service(), LocationListener {
    ...
    private fun startWatching() {
        ...
        val timingActive = existing.state == "ARMED" || existing.state == "RUNNING" || RaceTimingPendingStore.read(this) != null
        if (!timingActive) {
    ...
    override fun onLocationChanged(location: Location) {
        ...
        if (runtime.state == "ARMED" || runtime.state == "RUNNING" || RaceTimingPendingStore.read(this) != null) {
